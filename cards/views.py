...
def detail(request, card_id):
    ...
    items = menu_items.objects.all()
    context = {"card_name":card.name, "card_set":card.set_code, "foil":card.foil, "set_num":card.set_num, "likeCollection":like_cards, "items": items}  #passes the card name that I need to display. can comma seperate no problem. The quotes are what you referencein the html
